...
interface LoginFormProps {
    ...
    onClose: () => void;
    onSwitchToSignup: () => void;
    onSwitchToForgot?: () => void; // optional prop
}

export function LoginForm({ isOpen, onClose, onSwitchToSignup, onSwitchToForgot }: LoginFormProps) {
    const [isLoading, setIsLoading] = useState(false)
    const { login } = useUser();
    const router = useRouter();
    const form = useForm<LoginFormValues>({
                        ...
                        <div className="flex items-center justify-end">
                            ...
                            <div className="flex items-center justify-end">
                                <button
                                    ...
                                    className="text-sm text-[#FF2B85] hover:text-pink-600 font-medium"
                                >
                                    Forgot password?
                                </button>
                            </div>
