...
// import { useUser } from '@/context/UserContext';
// import Link from 'next/link';
// import SearchInput from '../modules/SearchInput'; // আগের SearchInput কম্পোনেন্ট
...
//                             <div className="flex items-center gap-2 max-w-md text-gray-900 flex-1">
//                                 <MapPin className="w-5 h-5 shrink-0" />
...
//                                 <SearchInput foods={[]} onSearch={(term) => console.log(term)} />
//                             </div>
//                         </div>
