...
// export default function CategoryNavbar({ categories }: CategoryProps) {
...
//             <Input placeholder="Search in menu" className="pl-9 bg-gray-50" />
//           </div>
...
//                 <Button
//                   key={cat._id}
//                   id={cat.title}                    // optional – for navbar itself
//                   variant="ghost"
...
//   // Generate suggestions based on debounced term
//   useEffect(() => {
...
//     setSuggestions(matched.slice(0, 10)); // max 10 suggestions
...
//               className="pl-9 bg-gray-50 pr-10"
//               value={searchTerm}
...
export default function CategoryNavbar({
  ...
  // const handleCategoryClick = (cat: ICategory) => {
  //   setActiveCategory(cat.title);
  //   document.getElementById(cat._id)?.scrollIntoView({
  //     behavior: "smooth",
  //     block: "start",
  //   });
  // };
