...
//           : []
//       }
//       className="w-full border border-pink-500 rounded-xl px-6"
//     >
//       <AccordionItem value={category._id} id={category._id}>
//         <AccordionTrigger>
//           {category.title}
//         </AccordionTrigger>
...
//   activeCategoryIds = [],
// }: Props) {
//   const isOpen = activeCategoryIds.includes(category._id);

//   return (
//     <Accordion
//       type="multiple"
//       value={isOpen ? [category._id] : []}
//       className="w-full border border-pink-500 rounded-xl px-6"
//     >
...
export default function CategoryAccordion({
  ...
  return (
    <Accordion
      type="multiple"
      value={isOpen ? [category._id] : []}
      onValueChange={() => onToggle?.(category._id)}
      className="w-full border border-pink-500 rounded-xl px-6"
    >
      <AccordionItem value={category._id}>
        <AccordionTrigger>
