...
//   return (
//     <div className="w-full sticky top-46 bg-white rounded-xl border border-gray-200">
//       <div className="flex p-4">
//         <button
//           // onClick={() => setDelivery("DELIVERY")}
//           onClick={() => setDelivery(DeliveryOption.DELIVERY)}

//           className={`flex-1 py-4 text-center font-medium text-gray-900 hover:bg-gray-50 transition-colors ${delivery === DeliveryOption.DELIVERY
//             ? "bg-pink-50 border-2 border-pink-500 rounded-tl-lg rounded-bl-lg"
//             : "bg-white border-2 rounded-tl-lg rounded-bl-lg"
//             }`}
//         >
//           Delivery
//           <span className="block text-xs text-gray-900 mt-0.5">Standard (15 - 25 mins)</span>
//         </button>
//         <button
//           // onClick={() => setDelivery("PICKUP")}
//           onClick={() => setDelivery(DeliveryOption.PICKUP)}

//           className={`flex-1 py-4 text-center font-medium text-gray-900 hover:bg-gray-50 transition-colors ${delivery === DeliveryOption.PICKUP
//             ? "bg-pink-50 border-2 border-pink-500  rounded-tr-lg rounded-br-lg"
//             : "bg-white rounded-tr-lg border-2 rounded-br-lg"
//             }`}
//         >
//           Pick-up
//           <span className="block text-xs text-gray-900 mt-0.5">Standard (10 - 25 mins)</span>
//         </button>
//       </div>
...
export default function CartSidebar() {
  ...
  return (
    <div className="w-full sticky top-46 bg-white rounded-xl border border-gray-200 shadow-sm">
